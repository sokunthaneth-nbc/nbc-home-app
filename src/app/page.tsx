...
export default function SplashScreen() {
	...
	return (
		<section className="min-h-screen flex flex-col justify-center items-center relative bg-[#1c3b63]">
			{/* Centered Image */}
			<img
				src="/logo.png" // Replace this path with your actual image path
				alt="App Logo"
			...
			{/* Bottom Text */}
			<div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center px-4 text-white text-sm">
