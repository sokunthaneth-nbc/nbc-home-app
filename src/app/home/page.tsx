		...
		<>
			<main className="bg-white dark:bg-[#001346] p-4 pb-24 space-y-4">
				...
				{announcements.map((item) => (
					<div key={item.id} className="bg-[rgba(0,19,70,0.03)] dark:bg-gray p-[16px] rounded-[24px]">
						...
						<Link href="#">
							<span className="flex items-center gap-x-1 text-[#001346] dark:text-white dark:border-white text-[16px] font-[600] leading-normal rounded-[32px] bg-[rgba(0,19,70,0.05)] mt-4 h-[40px] w-[200px] px-[16px] py-[8px] hover:underline">
